        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Dołączono', value: `<t:${Math.floor(joinedAt / 1000)}:R>`, inline: true },
                    { name: 'Członkowie', value: `${memberCount}`, inline: true },
                    { name: 'Role', value: `${roles}`, inline: true },
                    { name: 'Emoji', value: `${emojis}`, inline: true },
                    { name: 'Stopień weryfikacji', value: baseVerification, inline: true },
                    { name: 'Boosty', value: `${guild.premiumSubscriptionCount}`, inline: true }
                );
